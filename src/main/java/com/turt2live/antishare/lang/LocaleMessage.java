...
public enum LocaleMessage{
	...
	HAVE_TOOL("tool-have"),
	GET_TOOL("tool-get"),
	SAVE_QUEUE_FULL("io-not-added"),
	SAVE_FAILED("io-not-saved"),
	SAVE_FAILED_NO_REQUEUE("io-not-saved"),
	LOG_BLOCK_WARNING("lb-warning"),
	...
	TOOL_ENABLE("tool.toggle-on"),
	TOOL_DISABLE("tool.toggle-off"),
	TOOL_HELP_GENERIC("tool.help-generic"),
	TOOL_HELP_SET("tool.help-set"),
	TOOL_HELP_SET2("tool.help-set-2"),
	TOOL_HELP_CUBOID("tool.help-cuboid"),
	TOOL_HELP_CUBOID2("tool.help-cuboid-2"),
	TOOL_HELP_COMMAND("tool.help-command"),
	TOOL_HELP_CREATED("tool.help-created"),
